---
layout: default
title: Garment ERP Country Guides — India, Bangladesh, Vietnam, Cambodia, Ethiopia
description: Country-specific guides for garment factory ERP adoption. Pricing, market data, compliance, and best fit for each region.
permalink: /country-guides.html
---
...
Scan ERP is built for CMT garment factories across South Asia, Southeast Asia, and Africa. Country-specific guides:
...
- Internet: 3-5 daily outages typical (edge caching critical)
...
- Northern Africa entry point for European brands
- Currency: MAD

## 🇱🇰 Sri Lanka

- Joint Apparel Association Forum (JAAF) member factories
- Currency: LKR

## 🇳🇵 Nepal (Origin Market)

- Where Scan ERP was built (Trishakti Apparel, Gaindakot)
- Currency: NPR
